...
hl("GitSignsChangedelete", { fg = p.tertiary })
hl("GitSignsTopdelete", { fg = p.error })
hl("GitSignsUntracked", { fg = p.outline_variant })
hl("GitSignsCurrentLineBlame", { fg = p.outline_variant, italic = true })
...
hl("NoiceCmdlinePopup", { fg = p.fg, bg = p.surface })
hl("NoiceCmdlinePopupBorder", { fg = p.primary, bg = p.surface })
hl("NoiceCmdlinePopupTitle", { fg = p.primary, bg = p.surface, bold = true })
...
hl("NoicePopupmenuMatch", { fg = p.primary, bold = true })
hl("NoiceMini", { fg = p.fg_muted, bg = p.bg_dim })
hl("SnacksIndent", { fg = p.outline_variant })
hl("SnacksIndentScope", { fg = p.primary })
hl("SnacksNotifierHistory", { fg = p.fg, bg = p.surface })
hl("SnacksNotifierHistoryTitle", { fg = p.primary, bg = p.surface, bold = true })
